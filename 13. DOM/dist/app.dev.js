...
var h1Elemento = document.getElementsByTagName("h1")[0];
var pElemento = document.getElementsByClassName("parrafo")[0];
var btn = document.getElementById("btn");
var btnStyle = document.getElementById("btnStyle");
var container = document.getElementById("container"); // Mostramos el texto de los elementos
...
pElemento.innerText = "Soy el nuevo parrafo"; // Ahora mostraremos por consola nuestros elementos para poder inspeccionar y ver cuales son las propuedades

console.log(document);
console.log(h1Elemento);
console.log(pElemento); // Quiero ver que pasa en window
...
console.log(window.location); // Aca le vamos a dar un funcionalidad cuando se haga click en el boton
...
btnStyle.addEventListener("click", function () {
  var nuevoDiv = container.querySelector(".nuevoDiv");
...
console.dir(window); // en window podemos ver inclusive el cache y otros elementos únicos de window