...
export const productos = [
  { id: 1, nombre: 'Globos', codigo: 'G001', categoria: 'Fiesta', stock: 1000, stockMinimo: 50, precioUnitario: 12.00, precioPorMayor: 10.00, precioPreferencial: 11.00, costoAdquisicion: 8.00, descripcion: 'Caja con 100 bolsas pequeñas de globos', foto: 'globos.jpg' },
  { id: 2, nombre: 'Quetillo', codigo: 'Q001', categoria: 'Fiesta', stock: 500, stockMinimo: 20, precioUnitario: 5.00, precioPorMayor: 4.50, precioPreferencial: 4.80, costoAdquisicion: 3.50, descripcion: 'Quetillo para fiestas', foto: 'quetillo.jpg' },
  { id: 3, nombre: 'Petardo', codigo: 'P001', categoria: 'Fiesta', stock: 800, stockMinimo: 30, precioUnitario: 20.00, precioPorMayor: 18.00, precioPreferencial: 19.00, costoAdquisicion: 15.00, descripcion: 'Petardo de alta potencia', foto: 'petardo.jpg' },
  { id: 4, nombre: 'Cerpentina', codigo: 'C001', categoria: 'Fiesta', stock: 1200, stockMinimo: 50, precioUnitario: 8.00, precioPorMayor: 7.50, precioPreferencial: 7.80, costoAdquisicion: 6.00, descripcion: 'Cerpentina para decoración de fiestas', foto: 'cerpentina.jpg' },
  { id: 5, nombre: 'Inflador', codigo: 'I001', categoria: 'Fiesta', stock: 150, stockMinimo: 10, precioUnitario: 25.00, precioPorMayor: 22.00, precioPreferencial: 23.00, costoAdquisicion: 18.00, descripcion: 'Inflador manual para globos', foto: 'inflador.jpg' },
  { id: 6, nombre: 'Banderín', codigo: 'B001', categoria: 'Fiesta', stock: 300, stockMinimo: 10, precioUnitario: 5.50, precioPorMayor: 5.00, precioPreferencial: 5.20, costoAdquisicion: 4.00, descripcion: 'Banderines decorativos para techos', foto: 'banderin.jpg' },
  { id: 7, nombre: 'Globo Lápiz', codigo: 'GL001', categoria: 'Fiesta', stock: 200, stockMinimo: 10, precioUnitario: 15.00, precioPorMayor: 13.00, precioPreferencial: 14.00, costoAdquisicion: 10.00, descripcion: 'Globo en forma de lápiz para eventos', foto: 'globo-lapiz.jpg' }
];
