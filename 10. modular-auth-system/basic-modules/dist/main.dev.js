...
var myCanvas = (0, _canvas.create)('myCanvas', document.body, 500, 500);
var reportList = (0, _canvas.createReportList)(myCanvas.id);
var square1 = (0, _square.draw)(myCanvas.ctx, 50, 50, 100, 'blue');
(0, _square.reportArea)(square1.length, reportList);
(0, _square.reportPerimeter)(square1.length, reportList); // Use the default

var square2 = (0, _square["default"])(myCanvas.ctx);