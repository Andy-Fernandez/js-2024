...
console.log(jargon.includes("jargon")); // 7.

var numeroRan = Math.ceil(Math.random() * 100);
console.log(numeroRan); // 8. Generate a random number between 50 and 100 inclusively.
// do{
...
console.log(getRandom(50, 100)); // 9.

console.log(getRandom(0, 255)); // 10.

var string = "JavaScript";
console.log(string[getRandom(0, string.length - 1)]); // 11.
